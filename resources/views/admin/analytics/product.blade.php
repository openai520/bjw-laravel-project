        ...
        <div class="px-4 py-6 sm:px-0">
            ...
            <div class="flex justify-between items-center mb-6">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-600">产品ID: {{ $product->id }} | 价格:
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-lg font-medium text-gray-900">{{ number_format($product->view_count) }}
                                    </dd>
                                </dl>
                            </div>
                        </div>
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-lg font-medium text-gray-900">
                                        {{ number_format($product->today_view_count) }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-lg font-medium text-gray-900">
                                        {{ number_format($product->view_count / max(1, request('days', 30)), 1) }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                        ...
                        @forelse($referrerStats as $index => $referrer)
                            ...
                            <div class="flex items-center justify-between p-3 border-b border-gray-100">
                                <div class="flex items-center space-x-3">
                                    <div class="flex-shrink-0">
                                        <span
                                            class="inline-flex items-center justify-center h-6 w-6 rounded-full bg-gray-200 text-gray-600 text-xs font-medium">
                                            {{ $index + 1 }}
                                        </span>
                                    </div>
