                    ...
                    <div class="flex-1 min-w-0">
                        <div class="flex items-center space-x-3">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-sm text-gray-500">{{ $inquiry->country }} •
                    ...
                    @foreach ($topCountriesByVisits as $index => $countryData)
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-3">
                                <div class="flex-shrink-0">
                                    <span
                                        class="inline-flex items-center justify-center h-8 w-8 rounded-full {{ $index === 0 ? 'bg-yellow-100 text-yellow-800' : ($index === 1 ? 'bg-gray-100 text-gray-800' : ($index === 2 ? 'bg-orange-100 text-orange-800' : 'bg-gray-50 text-gray-600')) }} text-sm font-medium">
                                        {{ $index + 1 }}
                                    </span>
                                </div>
                                <div>
