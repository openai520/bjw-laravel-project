...
<head>
    ...
    <link href="https://unpkg.com/filepond-plugin-image-preview@^4/dist/filepond-plugin-image-preview.css"
        rel="stylesheet" />
...
<body class="font-sans antialiased bg-gray-50" data-sidebar-open="false">
        ...
        <div class="flex-1 flex flex-col min-h-0 bg-white shadow-lg border-r border-gray-200">
            ...
            <nav class="mt-8 px-4 space-y-1 flex-1">
                <a href="{{ route('admin.dashboard') }}"
                    ...
                    <svg class="w-5 h-5 mr-3 flex-shrink-0 {{ request()->routeIs('admin.dashboard') ? 'text-blue-600' : 'text-gray-400 group-hover:text-gray-500' }}"
                ...
                <a href="{{ route('admin.categories.index') }}"
                    ...
                    <svg class="w-5 h-5 mr-3 flex-shrink-0 {{ request()->routeIs('admin.categories.*') ? 'text-blue-600' : 'text-gray-400 group-hover:text-gray-500' }}"
                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('admin.products.index') }}"
                    ...
                    <svg class="w-5 h-5 mr-3 flex-shrink-0 {{ request()->routeIs('admin.products.*') ? 'text-blue-600' : 'text-gray-400 group-hover:text-gray-500' }}"
                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('admin.inquiries.index') }}"
                    ...
                    <svg class="w-5 h-5 mr-3 flex-shrink-0 {{ request()->routeIs('admin.inquiries.*') ? 'text-blue-600' : 'text-gray-400 group-hover:text-gray-500' }}"
                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('admin.product_analytics.index') }}"
                    ...
                    <svg class="w-5 h-5 mr-3 flex-shrink-0 {{ request()->routeIs('admin.product_analytics.*') ? 'text-blue-600' : 'text-gray-400 group-hover:text-gray-500' }}"
                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('admin.ip_addresses.index') }}"
                    ...
                    <svg class="w-5 h-5 mr-3 flex-shrink-0 {{ request()->routeIs('admin.ip_addresses.*') ? 'text-blue-600' : 'text-gray-400 group-hover:text-gray-500' }}"
                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('admin.home_settings.index') }}"
                    ...
                    <svg class="w-5 h-5 mr-3 flex-shrink-0 {{ request()->routeIs('admin.home_settings.*') ? 'text-blue-600' : 'text-gray-400 group-hover:text-gray-500' }}"
                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="border-t border-gray-200 pt-4 mt-6">
                    <form method="POST" action="{{ route('admin.logout') }}">
                        @csrf
                        <button type="submit"
                            class="group flex items-center w-full px-3 py-2 text-sm font-medium text-gray-700 rounded-lg hover:bg-red-50 hover:text-red-700 transition-colors duration-150">
                            <svg class="w-5 h-5 mr-3 flex-shrink-0 text-gray-400 group-hover:text-red-500"
                                fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div class="lg:pl-64">
        <div class="flex flex-col flex-1 min-w-0">
            <!-- 顶部栏 -->
            <div
                class="sticky top-0 z-10 flex-shrink-0 flex h-16 bg-white shadow-sm border-b border-gray-200 lg:border-none">
                <!-- 移动端菜单按钮 - DISABLED -->
                <button disabled
            ...
            <main class="flex-1 relative overflow-y-auto focus:outline-none bg-gray-50"
                style="min-height: 500px; background-color: #f9fafb !important;">
                <div class="py-6" style="min-height: 400px;">
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"
                        style="min-height: 300px; background-color: rgba(255,0,0,0.1);">
                        <!-- Flash 消息 -->
                        @if (session('success'))
                            <div class="mb-6 bg-green-50 border border-green-200 rounded-lg p-4" role="alert">
                                <div class="flex">
                                    <div class="flex-shrink-0">
                                        <svg class="h-5 w-5 text-green-400" fill="none" viewBox="0 0 20 20"
                                            stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        @if (session('error'))
                            <div class="mb-6 bg-red-50 border border-red-200 rounded-lg p-4" role="alert">
                                <div class="flex">
                                    <div class="flex-shrink-0">
                                        <svg class="h-5 w-5 text-red-400" fill="none" viewBox="0 0 20 20"
                                            stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <script src="https://unpkg.com/filepond-plugin-file-validate-type@^1/dist/filepond-plugin-file-validate-type.js">
    </script>
