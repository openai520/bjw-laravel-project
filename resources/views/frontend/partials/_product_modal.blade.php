            ...
            <div class="modal-content-wrapper">
                ...
                <div class="modal-image-column">
                    <div class="modal-main-image">
                        <img :src="currentImageUrl" :alt="product.name" class="modal-product-image"
                    ...
                    <div class="modal-thumbnails" x-show="product.images && product.images.length > 1">
                        <template x-for="image in product.images" :key="image.id">
                            <button @click="changeMainImage(image.main_image_url)" class="modal-thumbnail-button"
                ...
                <div class="modal-details-column">
                    ...
                    <div class="mt-auto pt-4">
                        <p class="modal-min-order-notice"
                            x-text="`${translations.minimum_order_quantity || 'MOQ'}: ${product.min_order_quantity}`">
                        </p>
                        <div class="modal-actions">
                            <div class="quantity-selector">
                                ...
                                <input type="number" x-model.number="quantity" @change="validateQuantity()"
                                    :min="product.min_order_quantity || 1" class="quantity-input">
                            ...
                            <button @click="handleAddToCart()" :disabled="isAddingToCart" class="add-to-cart-btn">
                                ...
                                <span x-show="!isAddingToCart"
                                    x-text="translations.add_to_cart || 'Add to Cart'"></span>
                            </button>
                        </div>
                    </div>
                </div>
