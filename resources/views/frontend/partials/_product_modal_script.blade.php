            ...
            async openModal(productId) {
                ...
                try {
                    ...
                    if (data.success) {
                        ...
                        this.currentImageUrl = this.product.main_image_url || (this.product.images.length > 0 ? this
                            .product.images[0].main_image_url : '{{ asset('img/placeholder.svg') }}');
                    } else {
